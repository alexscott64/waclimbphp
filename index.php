...
<div class="w3-main" style="margin-left:250px">
    ...
    function get_grade($full, $grade, $id, $item)
    {
        ...
        if ($grade == "h") {
            ...
            $gradelink3 = "&grade=TMI";
        }
        if ($grade == "h") {
            $blogtitle = $item['title'];
        } else {
            $blogtitle = str_replace($hardgrade, $classicgrade, $item['title']);
        }
        if ($grade == "h") {
            $blogsummary = $item['summary'];;
        } else {
            $blogsummary = str_replace($hardgrade, $classicgrade, $item['summary']);
        }
    ...
    <!--
<div class="w3-center">
<?php // if ($page > 1){echo "<a href='".$urlprevious."'>";} 
?><button class="w3-button w3-large <?php // if ($page > 1){echo "w3-black";} else {echo "w3-lightgrey";} 
                                                                                                    ?>">&#8249;</button><?php if ($page > 1) {
                                                                                                                                                                                                echo "</a>";
                                                                                                                                                                                            } ?>
<?php // if ($page < $pagestotal){echo "<a href='".$urlnext."'>";} 
?><button class="w3-button w3-large <?php  // if ($page < $pagestotal){echo "w3-black";} else {echo "w3-lightgrey";} 
                                                                                                        ?>">&#8250;</button><?php if ($page < $pagestotal) {
                                                                                                                                                                                                                echo "</a>";
                                                                                                                                                                                                            } ?>
</div>
    -->
...
<title>PSA</title><div class='w3-content w3-center w3-large blog-text'><div><i class="fa fa-window-close w3-right w3-xxlarge" onclick="PSA()" aria-hidden="true"></i><div class='w3-container w3-white w3-card'><h2 class='w3-wide'>Whoo's Whimsical Home Reno: Fly-by Alert! 🦉🔨🎉</h2><p class='w3-opacity'><i>Apr 3rd 2023</i></p></div>
...
<div class='w3-container w3-white w3-card w3-display-container' style="height: 500px; overflow: scroll;"><p class='w3-left-align'><span style="color:">Hoot hoot! Owl's abode is gettin' a spruce! A lil' spring cleanin' turned up a wonky beam, oh dear! No frets, we're fixin' the roost lickety-split! April 7th, fly on by! 'Til then, flap elsewhere, or risk hoppin' over one wacky, un-cushioned landin'! 🦉✨🌸</p><div class=" w3-white w3-row-padding w3-padding-16 w3-center">
